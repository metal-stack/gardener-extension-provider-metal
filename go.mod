...
require (
	...
	github.com/gardener/gardener-extension-networking-calico v1.37.0
	github.com/gardener/gardener-extension-networking-cilium v1.31.0
	github.com/gardener/machine-controller-manager v0.50.0
	github.com/go-logr/logr v1.4.1
	github.com/go-openapi/strfmt v0.23.0
	github.com/golang/mock v1.6.0
	github.com/google/go-cmp v0.6.0
	github.com/metal-stack/duros-controller v0.8.5
	github.com/metal-stack/firewall-controller-manager v0.3.3
...
replace (
	github.com/gardener/gardener => github.com/gardener/gardener v1.80.0
