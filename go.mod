...
require (
	...
	github.com/gardener/gardener-extension-networking-calico v1.49.0
	...
	github.com/metal-stack/firewall-controller-manager v0.5.2-0.20260204095628-8cf61d4506de
