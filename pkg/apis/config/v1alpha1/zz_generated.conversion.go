...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NetpolsIngressController)(nil), (*config.NetpolsIngressController)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NetpolsIngressController_To_config_NetpolsIngressController(a.(*NetpolsIngressController), b.(*config.NetpolsIngressController), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NetpolsIngressController)(nil), (*NetpolsIngressController)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NetpolsIngressController_To_v1alpha1_NetpolsIngressController(a.(*config.NetpolsIngressController), b.(*NetpolsIngressController), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*NetworkPolicies)(nil), (*config.NetworkPolicies)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NetworkPolicies_To_config_NetworkPolicies(a.(*NetworkPolicies), b.(*config.NetworkPolicies), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NetworkPolicies)(nil), (*NetworkPolicies)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NetworkPolicies_To_v1alpha1_NetworkPolicies(a.(*config.NetworkPolicies), b.(*NetworkPolicies), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ControllerConfiguration_To_config_ControllerConfiguration(in *ControllerConfiguration, out *config.ControllerConfiguration, s conversion.Scope) error {
	...
	out.NetworkPolicies = (*config.NetworkPolicies)(unsafe.Pointer(in.NetworkPolicies))
	return nil
}
...
func autoConvert_config_ControllerConfiguration_To_v1alpha1_ControllerConfiguration(in *config.ControllerConfiguration, out *ControllerConfiguration, s conversion.Scope) error {
	...
	out.NetworkPolicies = (*NetworkPolicies)(unsafe.Pointer(in.NetworkPolicies))
	return nil
}
...
func autoConvert_v1alpha1_NetpolsIngressController_To_config_NetpolsIngressController(in *NetpolsIngressController, out *config.NetpolsIngressController, s conversion.Scope) error {
	out.Namespace = in.Namespace
	out.PodSelector = *(*map[string]string)(unsafe.Pointer(&in.PodSelector))
	return nil
}

// Convert_v1alpha1_NetpolsIngressController_To_config_NetpolsIngressController is an autogenerated conversion function.
func Convert_v1alpha1_NetpolsIngressController_To_config_NetpolsIngressController(in *NetpolsIngressController, out *config.NetpolsIngressController, s conversion.Scope) error {
	return autoConvert_v1alpha1_NetpolsIngressController_To_config_NetpolsIngressController(in, out, s)
}

func autoConvert_config_NetpolsIngressController_To_v1alpha1_NetpolsIngressController(in *config.NetpolsIngressController, out *NetpolsIngressController, s conversion.Scope) error {
	out.Namespace = in.Namespace
	out.PodSelector = *(*map[string]string)(unsafe.Pointer(&in.PodSelector))
	return nil
}

// Convert_config_NetpolsIngressController_To_v1alpha1_NetpolsIngressController is an autogenerated conversion function.
func Convert_config_NetpolsIngressController_To_v1alpha1_NetpolsIngressController(in *config.NetpolsIngressController, out *NetpolsIngressController, s conversion.Scope) error {
	return autoConvert_config_NetpolsIngressController_To_v1alpha1_NetpolsIngressController(in, out, s)
}

func autoConvert_v1alpha1_NetworkPolicies_To_config_NetworkPolicies(in *NetworkPolicies, out *config.NetworkPolicies, s conversion.Scope) error {
	out.IngressController = (*config.NetpolsIngressController)(unsafe.Pointer(in.IngressController))
	return nil
}

// Convert_v1alpha1_NetworkPolicies_To_config_NetworkPolicies is an autogenerated conversion function.
func Convert_v1alpha1_NetworkPolicies_To_config_NetworkPolicies(in *NetworkPolicies, out *config.NetworkPolicies, s conversion.Scope) error {
	return autoConvert_v1alpha1_NetworkPolicies_To_config_NetworkPolicies(in, out, s)
}

func autoConvert_config_NetworkPolicies_To_v1alpha1_NetworkPolicies(in *config.NetworkPolicies, out *NetworkPolicies, s conversion.Scope) error {
	out.IngressController = (*NetpolsIngressController)(unsafe.Pointer(in.IngressController))
	return nil
}

// Convert_config_NetworkPolicies_To_v1alpha1_NetworkPolicies is an autogenerated conversion function.
func Convert_config_NetworkPolicies_To_v1alpha1_NetworkPolicies(in *config.NetworkPolicies, out *NetworkPolicies, s conversion.Scope) error {
	return autoConvert_config_NetworkPolicies_To_v1alpha1_NetworkPolicies(in, out, s)
}
