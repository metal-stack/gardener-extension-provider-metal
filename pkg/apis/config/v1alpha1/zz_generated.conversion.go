...
func autoConvert_v1alpha1_DurosConfiguration_To_config_DurosConfiguration(in *DurosConfiguration, out *config.DurosConfiguration, s conversion.Scope) error {
	...
	if in.PartitionConfig != nil {
		...
		*out = make(map[string]config.DurosPartitionConfiguration, len(*in))
		for key, val := range *in {
			newVal := new(config.DurosPartitionConfiguration)
			if err := Convert_v1alpha1_DurosPartitionConfiguration_To_config_DurosPartitionConfiguration(&val, newVal, s); err != nil {
				return err
			}
			(*out)[key] = *newVal
		}
	} else {
		out.PartitionConfig = nil
	}
	return nil
}
...
func autoConvert_config_DurosConfiguration_To_v1alpha1_DurosConfiguration(in *config.DurosConfiguration, out *DurosConfiguration, s conversion.Scope) error {
	...
	if in.PartitionConfig != nil {
		...
		*out = make(map[string]DurosPartitionConfiguration, len(*in))
		for key, val := range *in {
			newVal := new(DurosPartitionConfiguration)
			if err := Convert_config_DurosPartitionConfiguration_To_v1alpha1_DurosPartitionConfiguration(&val, newVal, s); err != nil {
				return err
			}
			(*out)[key] = *newVal
		}
...
func autoConvert_v1alpha1_DurosPartitionConfiguration_To_config_DurosPartitionConfiguration(in *DurosPartitionConfiguration, out *config.DurosPartitionConfiguration, s conversion.Scope) error {
	...
	if in.StorageClasses != nil {
		...
		*out = make([]config.DurosSeedStorageClass, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_DurosSeedStorageClass_To_config_DurosSeedStorageClass(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
		out.StorageClasses = nil
	}
...
func autoConvert_config_DurosPartitionConfiguration_To_v1alpha1_DurosPartitionConfiguration(in *config.DurosPartitionConfiguration, out *DurosPartitionConfiguration, s conversion.Scope) error {
	...
	if in.StorageClasses != nil {
		...
		*out = make([]DurosSeedStorageClass, len(*in))
		for i := range *in {
			if err := Convert_config_DurosSeedStorageClass_To_v1alpha1_DurosSeedStorageClass(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
