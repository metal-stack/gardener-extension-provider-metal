...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*AuditPolicy)(nil), (*config.AuditPolicy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_AuditPolicy_To_config_AuditPolicy(a.(*AuditPolicy), b.(*config.AuditPolicy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.AuditPolicy)(nil), (*AuditPolicy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_AuditPolicy_To_v1alpha1_AuditPolicy(a.(*config.AuditPolicy), b.(*AuditPolicy), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AuditPolicy_To_config_AuditPolicy(in *AuditPolicy, out *config.AuditPolicy, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_v1alpha1_AuditPolicy_To_config_AuditPolicy is an autogenerated conversion function.
func Convert_v1alpha1_AuditPolicy_To_config_AuditPolicy(in *AuditPolicy, out *config.AuditPolicy, s conversion.Scope) error {
	return autoConvert_v1alpha1_AuditPolicy_To_config_AuditPolicy(in, out, s)
}

func autoConvert_config_AuditPolicy_To_v1alpha1_AuditPolicy(in *config.AuditPolicy, out *AuditPolicy, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_config_AuditPolicy_To_v1alpha1_AuditPolicy is an autogenerated conversion function.
func Convert_config_AuditPolicy_To_v1alpha1_AuditPolicy(in *config.AuditPolicy, out *AuditPolicy, s conversion.Scope) error {
	return autoConvert_config_AuditPolicy_To_v1alpha1_AuditPolicy(in, out, s)
}
...
func autoConvert_v1alpha1_ControllerConfiguration_To_config_ControllerConfiguration(in *ControllerConfiguration, out *config.ControllerConfiguration, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_AuditPolicy_To_config_AuditPolicy(&in.AuditPolicy, &out.AuditPolicy, s); err != nil {
		return err
	}
...
func autoConvert_config_ControllerConfiguration_To_v1alpha1_ControllerConfiguration(in *config.ControllerConfiguration, out *ControllerConfiguration, s conversion.Scope) error {
	...
	if err := Convert_config_AuditPolicy_To_v1alpha1_AuditPolicy(&in.AuditPolicy, &out.AuditPolicy, s); err != nil {
		return err
	}
