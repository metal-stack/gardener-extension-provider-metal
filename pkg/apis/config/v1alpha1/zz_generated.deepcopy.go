...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetpolsIngressController) DeepCopyInto(out *NetpolsIngressController) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetpolsIngressController.
func (in *NetpolsIngressController) DeepCopy() *NetpolsIngressController {
	if in == nil {
		return nil
	}
	out := new(NetpolsIngressController)
	in.DeepCopyInto(out)
	return out
}
