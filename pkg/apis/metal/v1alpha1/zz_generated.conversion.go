...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*WorkerFeatures)(nil), (*metal.WorkerFeatures)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_WorkerFeatures_To_metal_WorkerFeatures(a.(*WorkerFeatures), b.(*metal.WorkerFeatures), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*metal.WorkerFeatures)(nil), (*WorkerFeatures)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_metal_WorkerFeatures_To_v1alpha1_WorkerFeatures(a.(*metal.WorkerFeatures), b.(*WorkerFeatures), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_WorkerConfig_To_metal_WorkerConfig(in *WorkerConfig, out *metal.WorkerConfig, s conversion.Scope) error {
	if err := Convert_v1alpha1_WorkerFeatures_To_metal_WorkerFeatures(&in.FeatureGates, &out.FeatureGates, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_metal_WorkerConfig_To_v1alpha1_WorkerConfig(in *metal.WorkerConfig, out *WorkerConfig, s conversion.Scope) error {
	if err := Convert_metal_WorkerFeatures_To_v1alpha1_WorkerFeatures(&in.FeatureGates, &out.FeatureGates, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_WorkerFeatures_To_metal_WorkerFeatures(in *WorkerFeatures, out *metal.WorkerFeatures, s conversion.Scope) error {
	out.MachineControllerManagerOOT = (*bool)(unsafe.Pointer(in.MachineControllerManagerOOT))
	return nil
}

// Convert_v1alpha1_WorkerFeatures_To_metal_WorkerFeatures is an autogenerated conversion function.
func Convert_v1alpha1_WorkerFeatures_To_metal_WorkerFeatures(in *WorkerFeatures, out *metal.WorkerFeatures, s conversion.Scope) error {
	return autoConvert_v1alpha1_WorkerFeatures_To_metal_WorkerFeatures(in, out, s)
}

func autoConvert_metal_WorkerFeatures_To_v1alpha1_WorkerFeatures(in *metal.WorkerFeatures, out *WorkerFeatures, s conversion.Scope) error {
	out.MachineControllerManagerOOT = (*bool)(unsafe.Pointer(in.MachineControllerManagerOOT))
	return nil
}

// Convert_metal_WorkerFeatures_To_v1alpha1_WorkerFeatures is an autogenerated conversion function.
func Convert_metal_WorkerFeatures_To_v1alpha1_WorkerFeatures(in *metal.WorkerFeatures, out *WorkerFeatures, s conversion.Scope) error {
	return autoConvert_metal_WorkerFeatures_To_v1alpha1_WorkerFeatures(in, out, s)
}
