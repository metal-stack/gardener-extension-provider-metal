...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*MachineNetwork)(nil), (*metal.MachineNetwork)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_MachineNetwork_To_metal_MachineNetwork(a.(*MachineNetwork), b.(*metal.MachineNetwork), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*metal.MachineNetwork)(nil), (*MachineNetwork)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_metal_MachineNetwork_To_v1alpha1_MachineNetwork(a.(*metal.MachineNetwork), b.(*MachineNetwork), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Firewall_To_metal_Firewall(in *Firewall, out *metal.Firewall, s conversion.Scope) error {
	...
	out.MachineNetworks = *(*[]metal.MachineNetwork)(unsafe.Pointer(&in.MachineNetworks))
...
func autoConvert_metal_Firewall_To_v1alpha1_Firewall(in *metal.Firewall, out *Firewall, s conversion.Scope) error {
	...
	out.Image = in.Image
	out.Networks = *(*[]string)(unsafe.Pointer(&in.Networks))
	out.MachineNetworks = *(*[]MachineNetwork)(unsafe.Pointer(&in.MachineNetworks))
...
func autoConvert_v1alpha1_MachineNetwork_To_metal_MachineNetwork(in *MachineNetwork, out *metal.MachineNetwork, s conversion.Scope) error {
	out.Asn = (*int64)(unsafe.Pointer(in.Asn))
	out.Destinationprefixes = *(*[]string)(unsafe.Pointer(&in.Destinationprefixes))
	out.Ips = *(*[]string)(unsafe.Pointer(&in.Ips))
	out.Nat = (*bool)(unsafe.Pointer(in.Nat))
	out.Networkid = (*string)(unsafe.Pointer(in.Networkid))
	out.Networktype = (*string)(unsafe.Pointer(in.Networktype))
	out.Prefixes = *(*[]string)(unsafe.Pointer(&in.Prefixes))
	out.Private = (*bool)(unsafe.Pointer(in.Private))
	out.Underlay = (*bool)(unsafe.Pointer(in.Underlay))
	out.Vrf = (*int64)(unsafe.Pointer(in.Vrf))
	return nil
}

// Convert_v1alpha1_MachineNetwork_To_metal_MachineNetwork is an autogenerated conversion function.
func Convert_v1alpha1_MachineNetwork_To_metal_MachineNetwork(in *MachineNetwork, out *metal.MachineNetwork, s conversion.Scope) error {
	return autoConvert_v1alpha1_MachineNetwork_To_metal_MachineNetwork(in, out, s)
}

func autoConvert_metal_MachineNetwork_To_v1alpha1_MachineNetwork(in *metal.MachineNetwork, out *MachineNetwork, s conversion.Scope) error {
	out.Asn = (*int64)(unsafe.Pointer(in.Asn))
	out.Destinationprefixes = *(*[]string)(unsafe.Pointer(&in.Destinationprefixes))
	out.Ips = *(*[]string)(unsafe.Pointer(&in.Ips))
	out.Nat = (*bool)(unsafe.Pointer(in.Nat))
...
// Convert_metal_MachineNetwork_To_v1alpha1_MachineNetwork is an autogenerated conversion function.
func Convert_metal_MachineNetwork_To_v1alpha1_MachineNetwork(in *metal.MachineNetwork, out *MachineNetwork, s conversion.Scope) error {
	return autoConvert_metal_MachineNetwork_To_v1alpha1_MachineNetwork(in, out, s)
}
