...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NetworkServer)(nil), (*metal.RegistryMirror)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NetworkServer_To_metal_NetworkServer(a.(*NetworkServer), b.(*metal.RegistryMirror), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*metal.RegistryMirror)(nil), (*NetworkServer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_metal_NetworkServer_To_v1alpha1_NetworkServer(a.(*metal.RegistryMirror), b.(*NetworkServer), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_NetworkServer_To_metal_NetworkServer(in *NetworkServer, out *metal.RegistryMirror, s conversion.Scope) error {
	out.Name = in.Name
...
func Convert_v1alpha1_NetworkServer_To_metal_NetworkServer(in *NetworkServer, out *metal.RegistryMirror, s conversion.Scope) error {
	return autoConvert_v1alpha1_NetworkServer_To_metal_NetworkServer(in, out, s)
}

func autoConvert_metal_NetworkServer_To_v1alpha1_NetworkServer(in *metal.RegistryMirror, out *NetworkServer, s conversion.Scope) error {
	out.Name = in.Name
	out.Hostname = in.Hostname
	out.IP = in.IP
	out.Port = in.Port
...
func Convert_metal_NetworkServer_To_v1alpha1_NetworkServer(in *metal.RegistryMirror, out *NetworkServer, s conversion.Scope) error {
