...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*FirewallIDS)(nil), (*metal.FirewallIDS)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_FirewallIDS_To_metal_FirewallIDS(a.(*FirewallIDS), b.(*metal.FirewallIDS), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*metal.FirewallIDS)(nil), (*FirewallIDS)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_metal_FirewallIDS_To_v1alpha1_FirewallIDS(a.(*metal.FirewallIDS), b.(*FirewallIDS), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Firewall_To_metal_Firewall(in *Firewall, out *metal.Firewall, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_FirewallIDS_To_metal_FirewallIDS(&in.IDS, &out.IDS, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_metal_Firewall_To_v1alpha1_Firewall(in *metal.Firewall, out *Firewall, s conversion.Scope) error {
	...
	out.Image = in.Image
	out.Networks = *(*[]string)(unsafe.Pointer(&in.Networks))
	if err := Convert_metal_FirewallIDS_To_v1alpha1_FirewallIDS(&in.IDS, &out.IDS, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_FirewallIDS_To_metal_FirewallIDS(in *FirewallIDS, out *metal.FirewallIDS, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_v1alpha1_FirewallIDS_To_metal_FirewallIDS is an autogenerated conversion function.
func Convert_v1alpha1_FirewallIDS_To_metal_FirewallIDS(in *FirewallIDS, out *metal.FirewallIDS, s conversion.Scope) error {
	return autoConvert_v1alpha1_FirewallIDS_To_metal_FirewallIDS(in, out, s)
}

func autoConvert_metal_FirewallIDS_To_v1alpha1_FirewallIDS(in *metal.FirewallIDS, out *FirewallIDS, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_metal_FirewallIDS_To_v1alpha1_FirewallIDS is an autogenerated conversion function.
func Convert_metal_FirewallIDS_To_v1alpha1_FirewallIDS(in *metal.FirewallIDS, out *FirewallIDS, s conversion.Scope) error {
	return autoConvert_metal_FirewallIDS_To_v1alpha1_FirewallIDS(in, out, s)
}
