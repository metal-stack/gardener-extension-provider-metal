...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkerFeatures) DeepCopyInto(out *WorkerFeatures) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkerFeatures.
func (in *WorkerFeatures) DeepCopy() *WorkerFeatures {
	if in == nil {
		return nil
	}
	out := new(WorkerFeatures)
	in.DeepCopyInto(out)
	return out
}
