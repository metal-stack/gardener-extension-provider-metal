...
func AddToManagerWithOptions(mgr manager.Manager, opts AddOptions) error {
	return controlplane.Add(mgr, controlplane.AddArgs{
		Actuator: genericactuator.NewActuator(metal.Name, controlPlaneSecrets, shootAccessSecretsFunc, nil, nil, nil, nil, configChart, controlPlaneChart, cpShootChart, nil,
