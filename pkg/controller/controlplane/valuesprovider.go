...
var storageClassChart = &chart.Chart{
	...
	Images:     []string{metal.CSIPluginImageName, metal.CSIProvisionerImageName},
	Objects: []*chart.Object{
		{Type: &corev1.Namespace{}, Name: "csi-driver-lvm"},
		{Type: &storagev1.CSIDriver{}, Name: "csi-driver-lvm"},
		// mimic old storage-class
		{Type: &storagev1.StorageClass{}, Name: "csi-driver-lvm-linear"},
		{Type: &storagev1.StorageClass{}, Name: "csi-driver-lvm-stripped"},
		...
		{Type: &appsv1.DaemonSet{}, Name: "csi-driver-lvm-controller"},
	},
}
